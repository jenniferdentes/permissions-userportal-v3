...
export function IconUserEdit({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconUserMinus({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function CubXLogo({ className = 'w-8 h-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="8" fill="#0F172A" />
      <path d="M10 16a6 6 0 1 1 12 0" stroke="#38BDF8" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M16 10v12M10 16h12" stroke="#7DD3FC" strokeWidth="2" strokeLinecap="round" opacity=".5" />
